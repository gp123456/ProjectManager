...
public class StockView extends Common {
    private static final Logger LOG = Logger.getLogger(StockView.class.getName());
    ...
    public String View(Model model) {
        this.setTitle("Stock-View");
        this.setSide_bar("../stock/sidebar.jsp");
        this.setContent("../stock/View.jsp");
        setHeaderInfo(model);
