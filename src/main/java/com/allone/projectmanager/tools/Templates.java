...
public class Templates {
    ...
    public static final StyleBuilder styleItalicUnderlineBold;
    ...
    static {
        styleItalicUnderlineBold = stl.style().setItalic(Boolean.TRUE).setUnderline(Boolean.TRUE).setBold(Boolean.TRUE);
        ...
        dynamicReportsComponent = cmp
                .horizontalList(cmp.image(Templates.class.getResource("marpo_header_pfd.jpg")).setHorizontalAlignment(HorizontalAlignment.CENTER))
